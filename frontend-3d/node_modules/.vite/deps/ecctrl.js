...
import {
  ...
  useKeyboardControls,
  useSpring
} from "./chunk-KUYNXZHW.js";
import "./chunk-A344A4MR.js";
import {
  create
} from "./chunk-EPXIUZ6F.js";
import "./chunk-FGBNOIQX.js";
import {
  Canvas,
  useFrame,
  useThree
...
function createStore(createState) {
  ...
  const subscribeWithSelector3 = (listener, selector = getState, equalityFn = Object.is) => {
  ...
  const subscribe = (listener, selector, equalityFn) => {
    if (selector || equalityFn) {
      return subscribeWithSelector3(listener, selector, equalityFn);
    }
...
var subscribeWithSelector2 = (fn) => (set, get, api) => {
...
var Store = function Store2() {
  const store = create2(subscribeWithSelector2(() => ({
    data: {}
  })));
...
var MonitorCanvas = (0, import_react25.forwardRef)(function({
  ...
  return import_react25.default.createElement(Canvas2, {
    ref: canvas
  });
});
...
// node_modules/ecctrl/dist/Ecctrl.js
var useFollowCam = function(props3) {
  const { scene, camera } = useThree();
  let isMouseDown = false;
  let previousTouch1 = null;
  let previousTouch2 = null;
  let originZDis = props3.camInitDis;
  const camMaxDis = props3.camMaxDis;
  const camMinDis = props3.camMinDis;
  const camMoveSpeed = props3.camMoveSpeed;
  const camZoomSpeed = props3.camZoomSpeed;
  const camCollisionOffset = props3.camCollisionOffset;
  const pivot = (0, import_react28.useMemo)(() => new Object3D(), []);
  const followCam = (0, import_react28.useMemo)(() => {
  ...
  const cameraRayDir = (0, import_react28.useMemo)(() => new Vector3(), []);
  const cameraRayOrigin = (0, import_react28.useMemo)(() => new Vector3(), []);
  const cameraPosition = (0, import_react28.useMemo)(() => new Vector3(), []);
  const camLerpingPoint = (0, import_react28.useMemo)(() => new Vector3(), []);
  ...
  const onDocumentMouseMove = (e4) => {
    if (document.pointerLockElement || isMouseDown) {
      pivot.rotation.y -= e4.movementX * 2e-3 * camMoveSpeed;
      const vy = followCam.rotation.x + e4.movementY * 2e-3 * camMoveSpeed;
  ...
  const onDocumentMouseWheel = (e4) => {
    const vz = originZDis - e4.deltaY * 2e-3 * camZoomSpeed;
  ...
  const onTouchMove = (e4) => {
    e4.preventDefault();
    e4.stopImmediatePropagation();
    const touch1 = e4.targetTouches[0];
    const touch2 = e4.targetTouches[1];
    ...
    if (previousTouch2) {
      ...
      const pinchDis = Math.hypot(
        e4.touches[0].pageX - e4.touches[1].pageX,
        e4.touches[0].pageY - e4.touches[1].pageY
      );
...
function EcctrlAnimation(props3) {
  const group = (0, import_react28.useRef)();
  const { animations } = useGLTF(props3.characterURL);
  ...
  (0, import_react28.useEffect)(() => {
    initializeAnimationSet(props3.animationSet);
  }, []);
  (0, import_react28.useEffect)(() => {
    const action = actions[curAnimation ? curAnimation : props3.animationSet.jumpIdle];
    if (curAnimation === props3.animationSet.jump || curAnimation === props3.animationSet.jumpLand || curAnimation === props3.animationSet.action1 || curAnimation === props3.animationSet.action2 || curAnimation === props3.animationSet.action3 || curAnimation === props3.animationSet.action4) {
  ...
  return (0, import_jsx_runtime.jsx)(import_react28.Suspense, { fallback: null, children: (0, import_jsx_runtime.jsx)("group", { ref: group, dispose: null, userData: { camExcludeCollision: true }, children: props3.children }) });
}
var JoystickComponents = (props3) => {
  ...
  let joystickDis = 0;
  let joystickAng = 0;
  const touch1MovementVec2 = (0, import_react28.useMemo)(() => new Vector2(), []);
  const joystickMovementVec2 = (0, import_react28.useMemo)(() => new Vector2(), []);
  const [windowSize, setWindowSize] = (0, import_react28.useState)({ innerHeight, innerWidth });
  ...
  const joystickBaseGeo = (0, import_react28.useMemo)(() => new CylinderGeometry(2.3, 2.1, 0.3, 16), []);
  const joystickStickGeo = (0, import_react28.useMemo)(() => new CylinderGeometry(0.3, 0.3, 3, 6), []);
  const joystickHandleGeo = (0, import_react28.useMemo)(() => new SphereGeometry(1.4, 8, 8), []);
  const joystickBaseMaterial = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickStickMaterial = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickHandleMaterial = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.7 }), []);
  const setJoystick = useJoystickControls((state) => state.setJoystick);
  const resetJoystick = useJoystickControls((state) => state.resetJoystick);
  const onTouchMove = (0, import_react28.useCallback)((e4) => {
    e4.preventDefault();
    e4.stopImmediatePropagation();
    const touch1 = e4.targetTouches[0];
  ...
  return (0, import_jsx_runtime.jsxs)(import_react28.Suspense, { fallback: "null", children: [
    (0, import_jsx_runtime.jsx)(animated.group, { "position-x": springs.basePositionX, "position-y": springs.basePositionY, children: (0, import_jsx_runtime.jsx)("mesh", { geometry: joystickBaseGeo, material: joystickBaseMaterial, rotation: [-Math.PI / 2, 0, 0], ...props3.joystickBaseProps }) }),
    (0, import_jsx_runtime.jsxs)(animated.group, { "rotation-x": springs.topRotationX, "rotation-y": springs.topRotationY, children: [
      (0, import_jsx_runtime.jsx)("mesh", { geometry: joystickStickGeo, material: joystickStickMaterial, rotation: [-Math.PI / 2, 0, 0], position: [0, 0, 1.5], ...props3.joystickStickProps }),
      (0, import_jsx_runtime.jsx)("mesh", { geometry: joystickHandleGeo, material: joystickHandleMaterial, position: [0, 0, 4], ...props3.joystickHandleProps })
    ] })
  ] });
};
var ButtonComponents = ({ buttonNumber = 1, ...props3 }) => {
  const buttonLargeBaseGeo = (0, import_react28.useMemo)(() => new CylinderGeometry(1.1, 1, 0.3, 16), []);
  const buttonSmallBaseGeo = (0, import_react28.useMemo)(() => new CylinderGeometry(0.9, 0.8, 0.3, 16), []);
  const buttonTop1Geo = (0, import_react28.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop2Geo = (0, import_react28.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop3Geo = (0, import_react28.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop4Geo = (0, import_react28.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop5Geo = (0, import_react28.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonBaseMaterial = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const buttonTop1Material = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop2Material = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop3Material = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop4Material = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop5Material = (0, import_react28.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  ...
  return (0, import_jsx_runtime.jsxs)(import_react28.Suspense, { fallback: "null", children: [
    buttonNumber > 0 && (0, import_jsx_runtime.jsxs)(
      animated.group,
      {
        ...
        position: props3.buttonGroup1Position || (buttonNumber === 1 ? [0, 0, 0] : [2, 1, 0]),
        children: [
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props3.buttonLargeBaseProps, onPointerDown: () => onPointerDown(1) }),
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonTop1Geo, material: buttonTop1Material, position: [0, -0.3, 0], ...props3.buttonTop1Props })
        ]
      }
    ),
    buttonNumber > 1 && (0, import_jsx_runtime.jsxs)(
      animated.group,
      {
        ...
        rotation: [-Math.PI / 2, 0, 0],
        position: props3.buttonGroup2Position || [0.5, -1.3, 0],
        children: [
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props3.buttonLargeBaseProps, onPointerDown: () => onPointerDown(2) }),
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonTop2Geo, material: buttonTop2Material, position: [0, -0.3, 0], ...props3.buttonTop2Props })
        ]
      }
    ),
    buttonNumber > 2 && (0, import_jsx_runtime.jsxs)(
      animated.group,
      {
        ...
        rotation: [-Math.PI / 2, 0, 0],
        position: props3.buttonGroup3Position || [-1, 1, 0],
        children: [
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(3) }),
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonTop3Geo, material: buttonTop3Material, position: [0, -0.3, 0], ...props3.buttonTop3Props })
        ]
      }
    ),
    buttonNumber > 3 && (0, import_jsx_runtime.jsxs)(
      animated.group,
      {
        ...
        rotation: [-Math.PI / 2, 0, 0],
        position: props3.buttonGroup4Position || [-2, -1.3, 0],
        children: [
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(4) }),
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonTop4Geo, material: buttonTop4Material, position: [0, -0.3, 0], ...props3.buttonTop4Props })
        ]
      }
    ),
    buttonNumber > 4 && (0, import_jsx_runtime.jsxs)(
      animated.group,
      {
        ...
        rotation: [-Math.PI / 2, 0, 0],
        position: props3.buttonGroup5Position || [0.4, 2.9, 0],
        children: [
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(5) }),
          (0, import_jsx_runtime.jsx)("mesh", { geometry: buttonTop5Geo, material: buttonTop5Material, position: [0, -0.3, 0], ...props3.buttonTop5Props })
        ]
      }
    )
  ] });
};
var EcctrlJoystick = (0, import_react28.forwardRef)((props3, ref) => {
  const joystickWrapperStyle = {
    ...
    position: "fixed",
    zIndex: "9999",
    height: props3.joystickHeightAndWidth || "200px",
    width: props3.joystickHeightAndWidth || "200px",
    left: props3.joystickPositionLeft || "0",
    bottom: props3.joystickPositionBottom || "0"
  };
  const buttonWrapperStyle = {
    ...
    position: "fixed",
    zIndex: "9999",
    height: props3.buttonHeightAndWidth || "200px",
    width: props3.buttonHeightAndWidth || "200px",
    right: props3.buttonPositionRight || "0",
    bottom: props3.buttonPositionBottom || "0"
  };
  return (0, import_jsx_runtime.jsxs)("div", { ref, children: [
    (0, import_jsx_runtime.jsx)("div", { id: "ecctrl-joystick", style: joystickWrapperStyle, onContextMenu: (e4) => e4.preventDefault(), children: (0, import_jsx_runtime.jsxs)(
      Canvas,
      {
        shadows: true,
        orthographic: true,
        camera: {
          zoom: props3.joystickCamZoom || 26,
          position: props3.joystickCamPosition || [0, 0, 50]
        },
        children: [
          (0, import_jsx_runtime.jsx)(JoystickComponents, { ...props3 }),
          props3.children
        ]
      }
    ) }),
    (0, import_jsx_runtime.jsx)("div", { id: "ecctrl-button", style: buttonWrapperStyle, onContextMenu: (e4) => e4.preventDefault(), children: (0, import_jsx_runtime.jsxs)(
      Canvas,
      {
        shadows: true,
        orthographic: true,
        camera: {
          zoom: props3.buttonCamZoom || 26,
          position: props3.buttonCamPosition || [0, 0, 50]
        },
        children: [
          (0, import_jsx_runtime.jsx)(ButtonComponents, { ...props3 }),
          props3.children
        ]
      }
    ) })
...
var Ecctrl = (0, import_react28.forwardRef)(({
  children,
  debug = false,
  ...
  const characterRef = ref || (0, import_react28.useRef)();
  const characterModelRef = (0, import_react28.useRef)();
  const modelFacingVec = (0, import_react28.useMemo)(() => new Vector3(), []);
  const bodyFacingVec = (0, import_react28.useMemo)(() => new Vector3(), []);
  const bodyBalanceVec = (0, import_react28.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnX = (0, import_react28.useMemo)(() => new Vector3(), []);
  const bodyFacingVecOnY = (0, import_react28.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnZ = (0, import_react28.useMemo)(() => new Vector3(), []);
  const vectorY = (0, import_react28.useMemo)(() => new Vector3(0, 1, 0), []);
  const vectorZ = (0, import_react28.useMemo)(() => new Vector3(0, 0, 1), []);
  ...
  let canJump = false;
  let isFalling = false;
  const initialGravityScale = (0, import_react28.useMemo)(() => props3.gravityScale || 1, []);
  let isOnMovingObject = false;
  const standingForcePoint = (0, import_react28.useMemo)(() => new Vector3(), []);
  const movingObjectDragForce = (0, import_react28.useMemo)(() => new Vector3(), []);
  const movingObjectVelocity = (0, import_react28.useMemo)(() => new Vector3(), []);
  const movingObjectVelocityInCharacterDir = (0, import_react28.useMemo)(
    () => new Vector3(),
    []
  );
  const distanceFromCharacterToObject = (0, import_react28.useMemo)(() => new Vector3(), []);
  const objectAngvelToLinvel = (0, import_react28.useMemo)(() => new Vector3(), []);
  let dirLight = null;
  const cameraSetups = {
    camInitDis,
    camMaxDis,
  ...
  const pivotPosition = (0, import_react28.useMemo)(() => new Vector3(), []);
  const modelEuler = (0, import_react28.useMemo)(() => new Euler(), []);
  const modelQuat = (0, import_react28.useMemo)(() => new Quaternion(), []);
  const moveImpulse = (0, import_react28.useMemo)(() => new Vector3(), []);
  const movingDirection = (0, import_react28.useMemo)(() => new Vector3(), []);
  const moveAccNeeded = (0, import_react28.useMemo)(() => new Vector3(), []);
  const jumpVelocityVec = (0, import_react28.useMemo)(() => new Vector3(), []);
  const jumpDirection = (0, import_react28.useMemo)(() => new Vector3(), []);
  const currentVel = (0, import_react28.useMemo)(() => new Vector3(), []);
  const currentPos = (0, import_react28.useMemo)(() => new Vector3(), []);
  const dragForce = (0, import_react28.useMemo)(() => new Vector3(), []);
  const dragAngForce = (0, import_react28.useMemo)(() => new Vector3(), []);
  const wantToMoveVel = (0, import_react28.useMemo)(() => new Vector3(), []);
  const rejectVel = (0, import_react28.useMemo)(() => new Vector3(), []);
  let floatingForce = null;
  const springDirVec = (0, import_react28.useMemo)(() => new Vector3(), []);
  const characterMassForce = (0, import_react28.useMemo)(() => new Vector3(), []);
  const rayOrigin = (0, import_react28.useMemo)(() => new Vector3(), []);
  const rayCast = new rapier.Ray(rayOrigin, rayDir);
  let rayHit = null;
  let slopeAngle = null;
  let actualSlopeNormal = null;
  let actualSlopeAngle = null;
  const actualSlopeNormalVec = (0, import_react28.useMemo)(() => new Vector3(), []);
  const floorNormal = (0, import_react28.useMemo)(() => new Vector3(0, 1, 0), []);
  const slopeRayOriginRef = (0, import_react28.useRef)();
  const slopeRayorigin = (0, import_react28.useMemo)(() => new Vector3(), []);
  const slopeRayCast = new rapier.Ray(slopeRayorigin, slopeRayDir);
  let slopeRayHit = null;
  const moveCharacter = (_2, run, slopeAngle2, movingObjectVelocity2) => {
  ...
  return (0, import_jsx_runtime.jsxs)(
    RigidBody,
    {
      colliders: false,
      ref: characterRef,
      position: props3.position || [0, 5, 0],
      friction: props3.friction || -0.5,
      ...props3,
      children: [
